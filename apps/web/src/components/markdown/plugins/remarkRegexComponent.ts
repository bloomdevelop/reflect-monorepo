...
export const passThroughRehype: (name: string) => Handler =
    (name: string) => function (this: any, h: any, node: any) {
        // Use undefined as context if 'this' is not an object (for app-client/ESM environments)
        const ctx = (typeof this === 'object' && this !== null) ? this : undefined;
        return typeof h === 'function' ? h(ctx, name, node) : null;
    };
